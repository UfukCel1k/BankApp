...
{
    //AppUserRegisterDto yazmamızın sebebi tüm appuser datasını kullanmayacak olmamızdı eğer kulanırsak solid prensiplerini ezmiş oluruz o yüzden işimize yaran bilgileri kullanıyoruz.
    public class AppUserRegisterValidator : AbstractValidator<AppUserRegisterDto>
    {
        //ctor iki kere tab tuşuna basarsak yapıcı metod oluşturmuş oluruz.
